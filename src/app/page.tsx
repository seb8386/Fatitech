...
const TESTIMONIALS = [
  {
    ...
    content: "Fatech a complètement transformé ma façon de créer. L'IA génère des idées que je n'aurais jamais trouvées seule. +120K abonnés en 4 mois !",
    stars: 5,
  },
  {
    ...
    content: "Gérer 30 clients avec Fatech, c'est comme avoir une équipe de 10 personnes. L'automatisation IA nous a fait économiser 40h/semaine.",
    stars: 5,
  },
  {
    name: "Laura Fontaine",
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-hidden scroll-smooth">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-black">
              Fa<span className="text-violet-400">tech</span>
            </span>
          </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-slate-950/95 border-b border-white/10 px-6 py-4 space-y-4 backdrop-blur-2xl">
            {NAV_LINKS.map((item) => (
              <a
                key={item.href}
                href={item.href}
            ...
            <div className="pt-2 flex flex-col gap-2">
              ...
              <Link
                href="/register"
                className="block text-center py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 text-sm font-bold text-white shadow-lg shadow-violet-500/25"
              >
                Commencer gratuitement
              </Link>
            </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <Link
                href="/register"
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-bold text-lg shadow-xl shadow-violet-500/30 hover:shadow-violet-500/50 transition-all hover:scale-105"
              >
                <Sparkles size={20} />
              ...
              <Link
                href="/login"
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 rounded-2xl border border-white/20 bg-white/5 text-white font-bold text-lg hover:bg-white/10 transition-all"
              >
                Voir la démo live
              </Link>
            </div>
          ...
          <div className="mt-20 relative max-w-5xl mx-auto">
            ...
            <div className="rounded-2xl border border-white/10 overflow-hidden shadow-2xl shadow-violet-900/40 bg-slate-900">
              <img
                src="/images/dashboard-preview.png"
                alt="Aperçu du tableau de bord Fatech"
            ...
            <div className="space-y-4">
              <div className="rounded-2xl border border-white/10 bg-slate-900/80 p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-bold text-white">Assistant IA Fatech</span>
      ...
      <section id="pricing" className="py-24 bg-slate-900/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-white mb-4">Tarifs simples et transparents</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            {PRICING.map((plan) => (
              <div
                key={plan.name}
                className={`rounded-2xl border p-6 relative flex flex-col justify-between ${
                  plan.popular
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <span className="px-4 py-1.5 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 text-xs font-bold text-white shadow-lg whitespace-nowrap">
                      ⭐ Le plus populaire
                    </span>
                  </div>
                )}
      ...
      <section id="testimonials" className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400">50 000+ créateurs et agences utilisent Fatech</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TESTIMONIALS.map((t) => (
              <div
                key={t.name}
                className="rounded-2xl border border-white/10 bg-slate-900/80 p-6 hover:border-white/20 transition-all flex flex-col justify-between"
              >
                <div>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="rounded-3xl border border-violet-500/30 bg-gradient-to-br from-violet-900/30 via-indigo-900/30 to-slate-900 p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
                Rejoignez 50 000+ créateurs qui automatisent leur présence sociale avec Fatech. Commencez gratuitement dès aujourd&apos;hui.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-sm text-slate-500">
              © {new Date().getFullYear()} Fatech AI. Tous droits réservés.
            </p>
